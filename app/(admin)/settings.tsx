            ...
            <ScrollView>
                ...
                <View style={styles.content}>
                        ...
                        <View style={styles.card}>
                            <View style={[styles.row, styles.lastRow]}>
                                ...
                                <View style={styles.rowContent}>
                                    <Text style={styles.rowTitle}>{userProfile?.full_name || 'Admin'}</Text>
                                    <Text style={styles.rowSubtitle}>{userProfile?.email}</Text>
                                    <Text style={[styles.rowSubtitle, { color: colors.primary }]}>Administrator</Text>
                                </View>
                            </View>
                        </View>
                    </View>
                    ...
                    <View style={styles.section}>
                        ...
                        <View style={styles.card}>
                            <View style={[styles.row, styles.lastRow]}>
                                ...
                                <View style={styles.rowContent}>
                                    <Text style={styles.rowTitle}>BDI LMS Admin</Text>
                                    <Text style={styles.rowSubtitle}>Version {Constants.expoConfig?.version || '1.0.0'}</Text>
                                </View>
                            </View>
                        </View>
                    </View>
                    ...
                    <Text style={styles.versionText}>
                        Admin Mobile View • BDI Learning Management System
                    </Text>
                </View>
            </ScrollView>
        </SafeAreaView>
