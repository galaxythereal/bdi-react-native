...
export default function DiplomaDetailsScreen() {
        ...
        return (
            <View style={[styles.container, { backgroundColor: colors.background, paddingTop: insets.top }]}>
                ...
                <View style={styles.errorContainer}>
                    <Text style={[styles.errorText, { color: colors.textSecondary }]}>Diploma not found.</Text>
                </View>
            </View>
        );
    }
    ...
    return (
        <View style={[styles.container, { backgroundColor: colors.background }]}>
            ...
            <View style={[styles.header, { height: 60 + insets.top, paddingTop: insets.top, zIndex: 50, backgroundColor: 'transparent' }]}>
                        ...
                        style={[
                            styles.dragHandle,
                            {
                                backgroundColor: scrollY.interpolate({
                                    inputRange: [0, 200],
                                    outputRange: ['rgba(255, 255, 255, 0.33)', 'rgba(207, 37, 37, 0.89)'], // Standard iOS colors
                                    extrapolate: 'clamp',
                                })
                            }
                        ]}
                    ...
                    <View style={styles.section}>
                        ...
                        {diploma.courses?.map((course, index) => (
                            <TouchableOpacity
                                ...
                                activeOpacity={0.8}
                            >
                                <View style={[styles.courseNumber, { backgroundColor: colors.primary }]}>
                                ...
                                <View style={styles.courseInfo}>
                                    ...
                                    <Text style={[styles.courseChapterCount, { color: colors.textTertiary }]}>
