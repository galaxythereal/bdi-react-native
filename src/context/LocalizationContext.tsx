...
const en: Translations = {
    ...
    startLabel: 'Start',
    failedLoadCourses: 'Failed to load programs.',
    ...
    courseCurriculum: 'Program Curriculum',
    enrollmentRequiredMessage: 'Please enroll in this diploma to access programs.',
    
    // Course
    startCourse: 'Start Program',
    resumeCourse: 'Resume Program',
    completed: 'Completed',
    progress: 'Progress',
    lessons: 'Lessons',
    quiz: 'Quiz',
    ...
    noCompletedCourses: 'No completed programs',
    noCoursesInProgress: 'No programs in progress',
    enrollInCourses: 'Enroll in programs to start learning',
    tryDifferentFilter: 'Try selecting a different filter',
    loadingCourses: 'Loading programs...',
    myCourses: 'My Programs',
    courseDetails: 'Program Details',
    courseContent: 'Program Content',
    aboutCourse: 'About This Program',
    ...
    // Course Player
    loadingCourse: 'Loading program...',
    failedLoadCourseContent: 'Failed to load program content',
    unableLoadCourse: 'Unable to Load Program',
    courseNotFound: 'Program not found',
    goBack: 'Go Back',
    offlineMode: 'Offline Mode',
    downloadingCourse: 'Downloading Program...',
    preparing: 'Preparing...',
    removeDownloadMessage: 'This will remove the downloaded program and all its content from your device. You can download it again later.',
    remove: 'Remove',
    removed: 'Removed',
    courseRemoved: 'Program has been removed from offline storage.',
    removeCourseFailed: 'Failed to remove program. Please try again.',
    failedDownloadCourse: 'Failed to download program. Please try again.',
    courseOfflineReady: 'Program is now available offline! You can access it from the Downloads tab.',
    ...
    previous: 'Previous',
    complete: 'Complete',
    courseCompletedTitle: 'Program Completed! 🎉',
    courseCompletedMessage: 'Congratulations! You have completed this program.',
    stayHere: 'Stay Here',
    ...
    noRankingsForCourse: 'No rankings available for this program yet.',
    points: 'Points',
    pointsShort: 'pts',
    quizzes: 'Quizzes',
    average: 'Average',
    ...
    accountCreatedMessage: 'Your account has been created! Please wait for admin approval before you can access programs.',
    ...
    signInToAccessCourses: 'Sign in to access your programs',
    ...
    totalCoursesLabel: 'Total Programs',
    ...
    failedLoadCourse: 'Failed to load program.',
    removeDownloadTitle: 'Remove Download',
    removedTitle: 'Removed',
    courseRemovedMessage: 'Program has been removed from offline storage.',
    failedRemoveCourse: 'Failed to remove program. Please try again.',
    ...
    completeCoursesToEarnCertificates: 'Complete programs to earn certificates',
    noCertificatesYet: 'No Certificates Yet',
    viewMyCourses: 'View My Programs',
    ...
    deleteCourseTitle: 'Delete Program',
    ...
    browseCourses: 'Browse Programs',
    noDownloadsYet: 'No Downloads Yet',
    downloadOfflineHint: 'Download programs to watch them offline.',
    goToCourseDownload: 'Go to a program and tap the download button.',
    failedDeleteCourse: 'Failed to delete program',
...
const ar: Translations = {
    ...
    continueLabel: 'تابع',
    startLabel: 'ابدأ',
    failedLoadCourses: 'فشل تحميل البرامج.',
    ...
    courseCurriculum: 'منهج البرامج',
    enrollmentRequiredMessage: 'يرجى التسجيل في هذا الدبلوم للوصول إلى البرامج.',
    
    // Course
    startCourse: 'بدء البرنامج',
    resumeCourse: 'متابعة البرنامج',
    completed: 'مكتمل',
    progress: 'التقدم',
    lessons: 'الدروس',
    quiz: 'اختبار',
    ...
    noCompletedCourses: 'لا توجد برامج مكتملة',
    noCoursesInProgress: 'لا توجد برامج قيد التقدم',
    enrollInCourses: 'سجل في البرامج لبدء التعلم',
    tryDifferentFilter: 'جرب تحديد مرشح مختلف',
    loadingCourses: 'جاري تحميل البرامج...',
    myCourses: 'برامجي',
    courseDetails: 'تفاصيل البرنامج',
    courseContent: 'محتوى البرنامج',
    aboutCourse: 'عن هذا البرنامج',
    ...
    // Course Player
    loadingCourse: 'جارٍ تحميل البرنامج...',
    failedLoadCourseContent: 'تعذر تحميل محتوى البرنامج',
    unableLoadCourse: 'تعذر تحميل البرنامج',
    courseNotFound: 'البرنامج غير موجود',
    goBack: 'عودة',
    offlineMode: 'وضع عدم الاتصال',
    downloadingCourse: 'جارٍ تنزيل البرنامج...',
    preparing: 'جارٍ التحضير...',
    removeDownloadMessage: 'سيؤدي ذلك إلى إزالة البرنامج المحمل وكل محتواه من جهازك. يمكنك تنزيلها مرة أخرى لاحقًا.',
    remove: 'إزالة',
    removed: 'تمت الإزالة',
    courseRemoved: 'تمت إزالة البرنامج من التخزين دون اتصال.',
    removeCourseFailed: 'تعذر إزالة البرنامج. يرجى المحاولة مرة أخرى.',
    failedDownloadCourse: 'فشل تنزيل البرنامج. يرجى المحاولة مرة أخرى.',
    courseOfflineReady: 'أصبح البرنامج متاحاً دون اتصال. يمكنك الوصول إليها من تبويب التنزيلات.',
    ...
    previous: 'السابق',
    complete: 'إكمال',
    courseCompletedTitle: 'اكتمل البرنامج! 🎉',
    courseCompletedMessage: 'تهانينا! لقد أكملت هذا البرنامج.',
    stayHere: 'البقاء هنا',
    ...
    noRankingsForCourse: 'لا توجد تصنيفات متاحة لهذا البرنامج بعد.',
    points: 'نقاط',
    pointsShort: 'ن',
    quizzes: 'اختبارات',
    average: 'المتوسط',
    ...
    accountCreatedMessage: 'تم إنشاء حسابك! يرجى انتظار موافقة الإدارة قبل الوصول إلى البرامج.',
    ...
    signInToAccessCourses: 'سجّل الدخول للوصول إلى برامجك',
    ...
    totalCoursesLabel: 'إجمالي البرامج',
    ...
    failedLoadCourse: 'فشل تحميل البرنامج.',
    removeDownloadTitle: 'إزالة التنزيل',
    removedTitle: 'تمت الإزالة',
    courseRemovedMessage: 'تمت إزالة البرنامج من التخزين دون اتصال.',
    failedRemoveCourse: 'فشل إزالة البرنامج. حاول مرة أخرى.',
    ...
    completeCoursesToEarnCertificates: 'أكمل البرامج للحصول على الشهادات',
    noCertificatesYet: 'لا توجد شهادات بعد',
    viewMyCourses: 'عرض برامجي',
    ...
    deleteCourseTitle: 'حذف البرنامج',
    ...
    clearAllDownloadsMessage: 'سيتم حذف جميع البرامج المحمّلة وعددها {count} وتحرير {size}. لا يمكن التراجع عن هذا الإجراء.',
    clearAllAction: 'حذف الكل',
    browseCourses: 'تصفح البرامج',
    noDownloadsYet: 'لا توجد تنزيلات بعد',
    downloadOfflineHint: 'حمّل البرامج لمشاهدتها بدون اتصال.',
    goToCourseDownload: 'اذهب إلى البرنامج واضغط زر التنزيل.',
    failedDeleteCourse: 'فشل حذف البرنامج',
